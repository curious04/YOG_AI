...
var OnboardProvider = function OnboardProvider(_ref3) {
  ...
  return React.createElement(OnboardContextProvider, {
    value: value
  }, children);
};
...
var OnboardElement = function OnboardElement(_ref) {
  ...
  var newChildren = cloneElement(children, _extends({}, children.props, {
    style: _extends({
      visibility: 'initial'
    }, children.props.style)
  }));
  return React.createElement(HighlightComponent, {
...
export { OnboardElement, OnboardProvider };
